...
const RAIL_LOCKED_CLASS =
  "blur-[3px] opacity-55 saturate-75 transition-all duration-200";
...
export const RightControlsColumn = memo(function RightControlsColumn({
  ...
  return (
    ...
    >
      ...
      <div
        data-testid="right-controls-action-layer"
        className={`relative ${isRightRailLocked ? RAIL_LOCKED_CLASS : ""}`}
      >
        {isRightRailLocked && (
          <div
            aria-hidden="true"
            data-testid="right-controls-lock-overlay"
