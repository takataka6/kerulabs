...
export const FlowchartPanel = memo(function FlowchartPanel({
  ...
  return (
    <>
      {/* バックドロップ: パネル外タッチ/クリックで閉じる */}
      <div
        className="fixed inset-0 z-20"
        onClick={onClose}
        aria-hidden="true"
      />
      <div className="absolute top-4 right-4 xl:right-6 bottom-4 xl:bottom-6 bg-slate-900/98 backdrop-blur-xl rounded-2xl border-2 border-purple-500/50 shadow-2xl w-[300px] xl:w-[420px] flex flex-col z-30">
