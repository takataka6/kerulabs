/**
 * @module BallPositionStep
 * @description タクティクス作成ウィザードのボール位置設定ステップコンポーネント。フィールド上でボール配置位置を指定する。
 */
...
interface BallPositionStepProps {
...
export const BallPositionStep = memo(function BallPositionStep({
  creation,
  offset,
  isDragging,
  handlePointerDown,
      ...
      <div className={`${CARD_BASE} border-teal-500/40 p-5 w-[380px]`}>
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className={`flex-1 ${BTN_SECONDARY} flex items-center justify-center gap-1`}
          >
            <span>←</span>
