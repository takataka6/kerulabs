...
export const DEFAULT_FORMATIONS = [
  ...
  Formation.createDefault(
    ...
    createRoleMap("4-4-2 Flat"),
  ),
  Formation.createDefault(
    new FormationId("4-4-2-diamond"),
    "4-4-2 Diamond",
    "4-4-2 Diamond",
    createFormationPositions([
      { pos: "GK", x: 0, z: -4.5, cat: "gk" },
      ...
      { pos: "RCB", x: -1, z: -3.3, cat: "df" },
      { pos: "RB", x: -3, z: -3, cat: "df" },
      { pos: "CDM", x: 0, z: -1.8, cat: "mf" },
      { pos: "LCM", x: 1.8, z: -0.7, cat: "mf" },
      { pos: "RCM", x: -1.8, z: -0.7, cat: "mf" },
      { pos: "CAM", x: 0, z: 0.8, cat: "mf" },
      { pos: "LST", x: 1, z: 2, cat: "fw" },
      { pos: "RST", x: -1, z: 2, cat: "fw" },
    ]),
    createRoleMap("4-4-2 Diamond"),
  ),
  Formation.createDefault(
  ...
  Formation.createDefault(
    ...
    createFormationPositions([
      ...
      { pos: "RCB", x: -1, z: -3.3, cat: "df" },
      { pos: "RB", x: -3, z: -3, cat: "df" },
      { pos: "DMF", x: 0, z: -1.9, cat: "mf" },
      { pos: "LM", x: 3.2, z: -0.3, cat: "mf" },
      { pos: "LCM", x: 1.2, z: -0.6, cat: "mf" },
      { pos: "RCM", x: -1.2, z: -0.6, cat: "mf" },
      { pos: "RM", x: -3.2, z: -0.3, cat: "mf" },
      { pos: "ST", x: 0, z: 2.2, cat: "fw" },
    ]),
    createRoleMap("4-1-4-1"),
  ),
  Formation.createDefault(
    new FormationId("4-3-1-2"),
    "4-3-1-2",
    "4-3-1-2",
    createFormationPositions([
      { pos: "GK", x: 0, z: -4.5, cat: "gk" },
      ...
      { pos: "RCB", x: -1, z: -3.3, cat: "df" },
      { pos: "RB", x: -3, z: -3, cat: "df" },
      { pos: "DMF", x: 0, z: -1.8, cat: "mf" },
      { pos: "LCM", x: 1.8, z: -0.8, cat: "mf" },
      { pos: "RCM", x: -1.8, z: -0.8, cat: "mf" },
      { pos: "CAM", x: 0, z: 0.6, cat: "mf" },
      { pos: "LST", x: 1.1, z: 2.2, cat: "fw" },
      { pos: "RST", x: -1.1, z: 2.2, cat: "fw" },
    ]),
    createRoleMap("4-3-1-2"),
  ),
  Formation.createDefault(
    new FormationId("4-2-2-2"),
    "4-2-2-2",
    "4-2-2-2",
    createFormationPositions([
      { pos: "GK", x: 0, z: -4.5, cat: "gk" },
      ...
      { pos: "RCB", x: -1, z: -3.3, cat: "df" },
      { pos: "RB", x: -3, z: -3, cat: "df" },
      { pos: "LDM", x: 1.1, z: -1.7, cat: "mf" },
      { pos: "RDM", x: -1.1, z: -1.7, cat: "mf" },
      { pos: "LAM", x: 1.8, z: 0.4, cat: "mf" },
      { pos: "RAM", x: -1.8, z: 0.4, cat: "mf" },
      { pos: "LST", x: 1, z: 2.1, cat: "fw" },
      { pos: "RST", x: -1, z: 2.1, cat: "fw" },
    ]),
    createRoleMap("4-2-2-2"),
  ),
  Formation.createDefault(
  ...
  Formation.createDefault(
    ...
    createFormationPositions([
      ...
      { pos: "CB", x: 0, z: -3.5, cat: "df" },
      { pos: "RCB", x: -2, z: -3.3, cat: "df" },
      { pos: "LM", x: 4, z: -0.8, cat: "mf" },
      { pos: "LCM", x: 1.4, z: -1, cat: "mf" },
      { pos: "RCM", x: -1.4, z: -1, cat: "mf" },
      { pos: "RM", x: -4, z: -0.8, cat: "mf" },
      { pos: "CAM", x: 0, z: 0.7, cat: "mf" },
      { pos: "LST", x: 1.1, z: 2.2, cat: "fw" },
      { pos: "RST", x: -1.1, z: 2.2, cat: "fw" },
    ]),
    createRoleMap("3-4-1-2"),
  ),
  Formation.createDefault(
    new FormationId("3-1-4-2"),
    "3-1-4-2",
    "3-1-4-2",
    createFormationPositions([
      { pos: "GK", x: 0, z: -4.5, cat: "gk" },
      ...
      { pos: "CB", x: 0, z: -3.5, cat: "df" },
      { pos: "RCB", x: -2, z: -3.3, cat: "df" },
      { pos: "DMF", x: 0, z: -2, cat: "mf" },
      { pos: "LM", x: 4, z: -0.6, cat: "mf" },
      { pos: "LCM", x: 1.3, z: -0.8, cat: "mf" },
      { pos: "RCM", x: -1.3, z: -0.8, cat: "mf" },
      { pos: "RM", x: -4, z: -0.6, cat: "mf" },
      { pos: "LST", x: 1.1, z: 2.2, cat: "fw" },
      { pos: "RST", x: -1.1, z: 2.2, cat: "fw" },
    ]),
    createRoleMap("3-1-4-2"),
  ),
  Formation.createDefault(
    new FormationId("5-4-1"),
    "5-4-1",
    "5-4-1",
    createFormationPositions([
      { pos: "GK", x: 0, z: -4.5, cat: "gk" },
      ...
      { pos: "RCB", x: -2, z: -3.5, cat: "df" },
      { pos: "RWB", x: -4, z: -2.5, cat: "df" },
      { pos: "LM", x: 3, z: -0.6, cat: "mf" },
      { pos: "LCM", x: 1, z: -1, cat: "mf" },
      { pos: "RCM", x: -1, z: -1, cat: "mf" },
      { pos: "RM", x: -3, z: -0.6, cat: "mf" },
      { pos: "ST", x: 0, z: 2.2, cat: "fw" },
    ]),
    createRoleMap("5-4-1"),
  ),
  Formation.createDefault(
    new FormationId("3-4-3"),
    "3-4-3",
    "3-4-3",
    createFormationPositions([
      { pos: "GK", x: 0, z: -4.5, cat: "gk" },
      ...
      { pos: "RCB", x: -2, z: -3.3, cat: "df" },
      { pos: "LM", x: 4, z: -0.8, cat: "mf" },
      { pos: "LCM", x: 1.5, z: -1.1, cat: "mf" },
      { pos: "RCM", x: -1.5, z: -1.1, cat: "mf" },
      { pos: "RM", x: -4, z: -0.8, cat: "mf" },
      { pos: "LW", x: 3, z: 1.8, cat: "fw" },
      { pos: "ST", x: 0, z: 2.5, cat: "fw" },
      { pos: "RW", x: -3, z: 1.8, cat: "fw" },
    ]),
    createRoleMap("3-4-3"),
  ),
  Formation.createDefault(
    new FormationId("4-3-2-1"),
    "4-3-2-1",
    "4-3-2-1",
    createFormationPositions([
      { pos: "GK", x: 0, z: -4.5, cat: "gk" },
      ...
      { pos: "RCB", x: -1, z: -3.3, cat: "df" },
      { pos: "RB", x: -3, z: -3, cat: "df" },
      { pos: "DMF", x: 0, z: -1.7, cat: "mf" },
      { pos: "LCM", x: 1.8, z: -0.8, cat: "mf" },
      { pos: "RCM", x: -1.8, z: -0.8, cat: "mf" },
      { pos: "LAM", x: 1.2, z: 0.8, cat: "mf" },
      { pos: "RAM", x: -1.2, z: 0.8, cat: "mf" },
      { pos: "ST", x: 0, z: 2.3, cat: "fw" },
    ]),
    createRoleMap("4-3-2-1"),
  ),
];
